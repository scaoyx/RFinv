...
# other_data <- list.files("D:/Science Research/2020-2021 Research Project/Scripts/FutureBCData/OtherLayers", pattern=".tif", full.names = TRUE)
...
SSP1262140_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP1264160_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
plot(SSP1264160_native_future_prediction, main='Native SSP 126 2041-2046 Prediction')
plot(LA_spdf, add=TRUE,border='dark grey')
pr <- SSP1264160_native_future_prediction
tr <- threshold(nat_erf,"spec_sens")
...
other_data <- list.files("D:/Science Research/2020-2021 Research Project/Scripts/FutureBCData/OtherLayers", pattern=".tif", full.names = TRUE)
SSP1268100_envi_layers_stack <- stack(c(SSP1264160_envi_map_layers,other_data))
...
SSP1268100_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
other_data <- list.files("D:/Science Research/2020-2021 Research Project/Scripts/FutureBCData/OtherLayers", pattern=".tif", full.names = TRUE)
SSP2452140_envi_layers_stack <- stack(c(SSP1264160_envi_map_layers,other_data))
...
SSP2452140_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP2454160_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP2456180_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP2458100_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP3702140_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP3704160_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP3706180_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP3708100_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP5852140_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP5854160_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP5856180_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
...
SSP5858100_native_future_prediction <- predict(envi_layers_stack,nat_for_prediction_rf_regress)
