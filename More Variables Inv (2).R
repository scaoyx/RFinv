...
write.table(rf_importance_total_sum,"InvasiveRFImportanceMoreVariables2nd.txt",quote=FALSE,sep="\t",row.names = FALSE)
...
8888884444444444k[pbbbbbbbbbbbbbbb=[  g[t[t[[[[
  
]]]]]]]]



# soooooooooooooooooooooooooooooool999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
...
#To save aggregated data frame.
write.table(inv_randomF_evaluation_total_summarized,paste("randomFInvasiveParsimonyFinalRFEvaluationMoreVariables5.txt",sep=""),quote=FALSE,sep="\t",row.names = TRUE)
...
for(i in 1:model_num){
  ...
  # Calculate Yule's Q.
  .t.mp <- invredo__erf@OR
  tmp[!is.finite(tmp)] <- NA 
  invredo__randomF_rf_evaluation$Q <- (mean(tmp,na.rm=T)-1)/(mean(tmp,na.rm=T)+1)
  invredo__randomF_rf_evaluation$TSS <- mean(inv_erf@TPR,na.rm=T)+mean(inv_erf@TNR,na.rm=T)-1
...
=;__randomF_evaluation_total_summarized <- as.data.frame(rbind(tmpMean,tmpSD))
#To save aggregated data frame.
write.table(invredo__randomF_evaluation_total_summarized,paste("Invasiveredo_randomFParsimonyFinalRFEvaluations2.txt",sep=""),quote=FALSE,sep="\t",row.names = TRUE)
...
for(i in 1:model_num){
  ...
  natredo__randomF_rf_evaluation$TSS <- mean(nat_erf@TPR,na.rm=T)+mean(nat_erf@TNR,na.rm=T)-1
...
#To save aggregated data frame.
write.table(natredo__randomF_evaluation_total_summarized,paste("nativeredo_randomFParsimonyFinalRFEvaluations2.txt",sep=""),quote=FALSE,sep="\t",row.names = TRUE)
...
#To save aggregated data frame.
write.table(nat_rf_importance_total_sum,"NativeRFImportanceMoreVariables2.txt",quote=FALSE,sep="\t",row.names = FALSE)
...
#Parsimonious random forest model
#PARSIMONIOUS!!
nat_for_prediction_rf_regress_test <- suppressWarnings(randomForest(envi_train[,colnames(envi_train) %in% envi_filename],envi_train$pa,stepFactor=1,plot=FALSE,doBest=TRUE))
