...
envi_map_layers <- list.files("./EnvironmentalFactors/ClimateFactors", full.names = TRUE)
...
for(envi_map_layer in envi_map_layers){
  envi_filename <- gsub("./EnvironmentalFactors/ClimateFactors/","",gsub(".tif","",envi_map_layer))
  # invasive species
...
for(envi_map_layer in envi_map_layers){
  envi_filename <- gsub("./EnvironmentalFactors/ClimateFactors/","",gsub(".tif","",envi_map_layer)) #Get short names for environmental layers.
...
envi_filename <- gsub("./EnvironmentalFactors/ClimateFactors/","",gsub(".tif","",envi_map_layers))
...
write.table(rf_importance_total_sum,"ClimateOnlyVarImp.txt",quote=FALSE,sep="\t",row.names = FALSE)
...
#To save aggregated data frame.
write.table(invredo__randomF_evaluation_total_summarized,paste("InvClimateOnlyRFEvaluations.txt",sep=""),quote=FALSE,sep="\t",row.names = TRUE)
...
#To save aggregated data frame.
write.table(natredo__randomF_evaluation_total_summarized,paste("natClimateOnlyRFEvaluations2.txt",sep=""),quote=FALSE,sep="\t",row.names = TRUE)
...
rf_importance_total_sum <- left_join(tmp,rf_importance_total_sum)
#To save aggregated data frame.
write.table(rf_importance_total_sum,"InvClimateOnlyTuneRF1.txt",quote=FALSE,sep="\t",row.names = FALSE)
...
RFPlots <- plot_grid(RFp1Plot,RFp2Plot,RFp8Plot,RFp9Plot,RFp10Plot,RFp11Plot,RFp12Plot,
                     RFp13Plot,RFp14Plot,RFp15Plot,RFp18Plot,
                     RFp19Plot,RFp20Plot,RFp22Plot,RFp24Plot,
                     RFp25Plot,RFp26Plot,RFp28Plot,RFp29Plot,ncol=2,labels="AUTO")
png(paste("ClimateOnlyPartialDependence.png",sep=""),width=2*800,height=400*length(envi_filename))
...
rf_importance_total_sum <- left_join(tmp,rf_importance_total_sum)
#To save aggregated data frame.
write.table(rf_importance_total_sum,"NatClimateOnlyTuneRF1.txt",quote=FALSE,sep="\t",row.names = FALSE)
...
RFPlots <- plot_grid(RFp1Plot,RFp2Plot,RFp8Plot,RFp9Plot,RFp10Plot,RFp11Plot,RFp12Plot,
                     ...
                     RFp19Plot,RFp20Plot,RFp22Plot,RFp24Plot,
                     RFp25Plot,RFp26Plot,RFp28Plot,RFp29Plot,ncol=2,labels="AUTO")
png(paste("NatClimateOnlyPartialDependence.png",sep=""),width=2*800,height=400*length(envi_filename))
